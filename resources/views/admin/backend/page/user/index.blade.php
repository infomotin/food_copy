                    ...
                    <div class="page-title-right">
                        <ol class="m-0 breadcrumb">
                            <a href="{{route('add.user')}}"
                                class="btn btn-primary waves-effect waves-light">Add User</a>&nbsp;&nbsp;
                                <a href="{{route('admin.add.import')}}"
                    ...
                    <div class="card-body">
                        <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td><img src="{{asset('upload/admins/'.$item->profile_photo_path)}}" style="width: 50px; height: 50px;" alt=""></td>
                                    <td>{{$item->name}}</td>
                                    <td>{{'role'}}</td>
                                    <td>{{$item->email}}</td>
                                    <td>{{$item->phone}}</td>
                                    ...
                                    <td>
                                        <a href="{{route('admin.edit.permition', $item->id)}}" class="btn btn-info sm"
                                            title="Edit Data"> <i class="fas fa-edit"></i> </a>
                                        <a href="{{route('admin.delete.permition', $item->id)}}"
