            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.addPermission.store')}}" method="POST"  id="myForm">
                            @csrf
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="guard_name" type="text" id="example-search-input">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="example-search-input" class="col-sm-2 col-form-label">Group Name</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="group_name" type="text" id="example-search-input">
                                </div>
                            </div>
