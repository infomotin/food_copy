            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.update.role', $role->id)}}" method="POST"  id="myForm">
                            @csrf
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="guard_name" type="text" id="example-search-input" value="{{$role->guard_name}}" readonly>
                                </div>
                            </div>
