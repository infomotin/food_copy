...
<html lang="en">
   ...
   <body>
            ...
            <div class="row d-flex align-items-center py-lg-4">
               <div class="mx-auto col-lg-8">
                  <div class="text-center homepage-search-title">
                     <h1 class="mb-2 text-white display-4 text-shadow font-weight-normal"><span class="font-weight-bold">Discover the best food & drinks in India 🇮🇳
                     </span></h1>
                  ...
                  <h6 class="mt-4 text-white text-shadow font-weight-normal">E.g. Beverages, Pizzas, Chinese, Bakery, Indian...</h6>
            ...
            <div class="row">
               <div class="col-md-3 col-6">
                  <div class="products-box">
                     <a href="listing.html"><img alt="" src="img/pro1.jpg" class="rounded img-fluid"></a>
                  </div>
               </div>
               <div class="col-md-3 col-6">
                  <div class="products-box">
                     <a href="listing.html"><img alt="" src="img/pro2.jpg" class="rounded img-fluid"></a>
                  </div>
               </div>
               <div class="col-md-3 col-6">
                  <div class="products-box">
                     <a href="listing.html"><img alt="" src="img/pro3.jpg" class="rounded img-fluid"></a>
                  </div>
               </div>
               <div class="col-md-3 col-6">
                  <div class="products-box">
                     <a href="listing.html"><img alt="" src="img/pro4.jpg" class="rounded img-fluid"></a>
                  </div>
               </div>
            </div>
         </div>
                        ...
                        <div class="overflow-hidden bg-white rounded shadow-sm list-card h-100 position-relative">
                           ...
                           <div class="p-3 position-relative">
                              <div class="list-card-body">
                                 ...
                                 <p class="mb-3 text-gray time"><span class="pt-1 pb-1 pl-2 pr-2 rounded-sm bg-light text-dark"><i class="icofont-wall-clock"></i> 20–25 min</span> <span class="float-right text-black-50"> $250 FOR TWO</span></p>
                              </div>
                        ...
                        <div class="overflow-hidden bg-white rounded shadow-sm list-card h-100 position-relative">
                           ...
                           <div class="p-3 position-relative">
                              <div class="list-card-body">
                                 ...
                                 <p class="mb-3 text-gray time"><span class="pt-1 pb-1 pl-2 pr-2 rounded-sm bg-light text-dark"><i class="icofont-wall-clock"></i> 15–25 min</span> <span class="float-right text-black-50"> $100 FOR TWO</span></p>
                              </div>
                              <div class="list-card-badge">
      ...
      <section class="pt-5 pb-5 bg-white section becomemember-section border-bottom">
         <div class="container">
            <div class="text-center section-header white-text">
