                     ...
                     <div class="p-4 border-bottom">
                        <div class="text-center osahan-user">
                           <div class="osahan-user-media">
                              <img class="mt-1 mb-3 shadow-sm rounded-pill" src="img/user/4.png" alt="gurdeep singh osahan">
                        ...
                        <div class="tab-pane fade show active" id="orders" role="tabpanel" aria-labelledby="orders-tab">
                           ...
                           <div class="mb-4 bg-white shadow-sm card order-list">
                              <div class="p-4 gold-members">
                                 ...
                                 <p class="mb-1 text-gray"><i class="icofont-location-arrow"></i> 730 S Mendenhall Rd, Memphis, TN 38117, USA
                                 </p>
                                 <p class="mb-3 text-gray"><i class="icofont-list"></i> ORDER #25102589748 <i class="ml-2 icofont-clock-time"></i> Mon, Nov 12, 6:26 PM</p>
                                 ...
                                 <p class="pt-2 mb-0 text-black text-primary"><span class="text-black font-weight-bold"> Total Paid:</span>  $300
                                 </p>
                                 </div>
                                 </div>
                                 </a>
                           ...
                           <div class="mb-4 bg-white shadow-sm card order-list">
                              <div class="p-4 gold-members">
                                 ...
                                 <p class="mb-1 text-gray"><i class="icofont-location-arrow"></i> 1733 Ocean Ave, Santa Monica, CA 90401, USA
                                 </p>
                                 <p class="mb-3 text-gray"><i class="icofont-list"></i> ORDER #25102589748 <i class="ml-2 icofont-clock-time"></i> Mon, Nov 12, 6:26 PM</p>
                                 ...
                                 <p class="pt-2 mb-0 text-black text-primary"><span class="text-black font-weight-bold"> Total Paid:</span>  $500
                                 </p>
                                 </div>
                                 </div>
                                 </a>
                           ...
                           <div class="bg-white shadow-sm card order-list">
                              <div class="p-4 gold-members">
                                 <a href="#">
                                    <div class="media">
                                 ...
                                 <p class="mb-1 text-gray"><i class="icofont-location-arrow"></i> 953 S Main St, Centerville, OH 45459, USA
                                 </p>
                                 <p class="mb-3 text-gray"><i class="icofont-list"></i> ORDER #25102589748 <i class="ml-2 icofont-clock-time"></i> Mon, Nov 12, 6:26 PM</p>
                                 ...
                                 <p class="pt-2 mb-0 text-black text-primary"><span class="text-black font-weight-bold"> Total Paid:</span>  $420
                                 </p>
                                 </div>
                                 </div>
                                 </a>
                              ...
                              <div class="col-md-6">
                                 <div class="shadow-sm card offer-card">
                                    <div class="card-body">
                                       ...
                                       <h6 class="mb-2 card-subtitle text-block">Get 50% OFF on your first osahan eat order</h6>
                                 ...
                                 <div class="overflow-hidden bg-white rounded shadow-sm list-card h-100 position-relative">
                                    ...
                                    <div class="p-3 position-relative">
                                       <div class="list-card-body">
                                          ...
                                          <p class="mb-3 text-gray time"><span class="pt-1 pb-1 pl-2 pr-2 rounded-sm bg-light text-dark"><i class="icofont-wall-clock"></i> 15–30 min</span> <span class="float-right text-black-50"> $350 FOR TWO</span></p>
                                       </div>
                                 ...
                                 <div class="overflow-hidden bg-white rounded shadow-sm list-card h-100 position-relative">
                                    ...
                                    <div class="p-3 position-relative">
                                       <div class="list-card-body">
                                          ...
                                          <p class="mb-3 text-gray time"><span class="pt-1 pb-1 pl-2 pr-2 rounded-sm bg-light text-dark"><i class="icofont-wall-clock"></i> 30–35 min</span> <span class="float-right text-black-50"> $250 FOR TWO</span></p>
                                       </div>
                                       <div class="list-card-badge">
                                 ...
                                 <div class="overflow-hidden bg-white rounded shadow-sm list-card h-100 position-relative">
                                    ...
                                    <div class="p-3 position-relative">
                                       <div class="list-card-body">
                                          ...
                                          <p class="mb-3 text-gray time"><span class="pt-1 pb-1 pl-2 pr-2 rounded-sm bg-light text-dark"><i class="icofont-wall-clock"></i> 15–25 min</span> <span class="float-right text-black-50"> $500 FOR TWO</span></p>
                                       </div>
                                       <div class="list-card-badge">
                                 ...
                                 <div class="overflow-hidden bg-white rounded shadow-sm list-card h-100 position-relative">
                                    ...
                                    <div class="p-3 position-relative">
                                       <div class="list-card-body">
                                          ...
                                          <p class="mb-3 text-gray">North Indian • Indian • Pure veg</p>
                                          <p class="mb-3 text-gray time"><span class="pt-1 pb-1 pl-2 pr-2 rounded-sm bg-light text-dark"><i class="icofont-wall-clock"></i> 15–25 min</span> <span class="float-right text-black-50"> $250 FOR TWO</span></p>
                                       </div>
                                       <div class="list-card-badge">
                                    ...
                                    <div class="p-4 gold-members">
                                       <div class="media">
                                          ...
                                          <div class="media-body">
                                             ...
                                             <p class="mb-0 text-black font-weight-bold"><a class="mr-3 text-primary" data-toggle="modal" data-target="#add-address-modal"  href="#"><i class="icofont-ui-edit"></i> EDIT</a> <a class="text-danger" data-toggle="modal" data-target="#delete-address-modal" href="#"><i class="icofont-ui-delete"></i> DELETE</a></p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
