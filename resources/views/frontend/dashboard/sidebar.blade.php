               ...
               <div class="col-md-3">
                <div class="bg-white rounded shadow-sm osahan-account-page-left h-100">
                      ...
                      <div class="text-center osahan-user">
                        ...
                        @endphp
                         <div class="osahan-user-media">
                            <img class="mt-1 mb-3 shadow-sm rounded-pill" src="{{(!empty($userData->profile_photo_path))?url('upload/users/'.$userData->profile_photo_path):url('upload/no_image.jpg')}}" alt="gurdeep singh osahan">
                   ...
                   <ul class="pt-4 pb-4 pl-4 border-0 nav nav-tabs flex-column" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true"><i class="icofont-food-cart"></i> User Profile</a>
                     </li>
                      <li class="nav-item">
