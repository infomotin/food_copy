         ...
         <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  </button><button type="button" class="text-center btn d-flex w-50 justify-content-center btn-primary">UPDATE</button>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="modal fade" id="delete-address-modal" tabindex="-1" role="dialog" aria-labelledby="delete-address" aria-hidden="true">
         <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  <button type="button" class="text-center btn d-flex w-50 justify-content-center btn-outline-primary" data-dismiss="modal">CANCEL
                  </button><button type="button" class="text-center btn d-flex w-50 justify-content-center btn-primary">DELETE</button>
               </div>
            </div>
         </div>
      </div>
