    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
       <div class="modal-content">
          ...
          <div class="modal-footer">
             <button type="button" class="text-center btn d-flex w-50 justify-content-center btn-outline-primary" data-dismiss="modal">CANCEL
             </button><button type="button" class="text-center btn d-flex w-50 justify-content-center btn-primary">SUBMIT</button>
          </div>
       </div>
    </div>
</div>
                            ...
                            <div class="p-4 gold-members">
                               <div class="media">
                                  ...
                                  <div class="media-body">
                                     ...
                                     <p class="mb-0 text-black font-weight-bold"><a data-toggle="modal" data-target="#add-address-modal" class="mr-2 btn btn-sm btn-primary" href="#"> ADD NEW ADDRESS</a> 
                                     </p>
                                  </div>
                               </div>
                            </div>
          ...
          <div class="col-md-4">
             <div class="p-4 mb-4 rounded shadow-sm generator-bg osahan-cart-item">
                <div class="mb-4 d-flex osahan-cart-item-profile">
                   <img class="mr-3 img-fluid rounded-pill" alt="osahan" src="{{asset('frontend/img/2.jpg')}}">
                   <div class="d-flex flex-column">
                ...
                <div class="clearfix p-2 mb-2 bg-white rounded">
                   ...
                   <hr />
                   <h6 class="mb-0 font-weight-bold">TO PAY  <span class="float-right">$1329</span></h6>
                </div>
                <a href="thanks.html" class="btn btn-success btn-block btn-lg">PAY $1329
                <i class="icofont-long-arrow-right"></i></a>
             </div>
