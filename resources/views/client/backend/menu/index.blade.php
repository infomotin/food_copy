                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="m-0 breadcrumb">
                            <a href="{{route('client.menu.add')}}" class="btn btn-primary waves-effect waves-light">Add Menu</a>
                        </ol>
                    </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{(!empty($item->menu_icon))?url('upload/menus/'.$item->menu_icon):url('upload/no_image.jpg')}}" height="50" width="50" alt=""></td>
                                    <td>
