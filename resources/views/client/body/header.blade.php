    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{(!empty($userData->profile_photo_path))?url('upload/clients/'.$userData->profile_photo_path):url('upload/no_image.jpg')}}"
                        alt="Header Avatar">
